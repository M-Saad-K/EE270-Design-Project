...
## don't need the decimal point
#set_property PACKAGE_PIN V7 [get_ports dp]							
	#set_property IOSTANDARD LVCMOS33 [get_ports dp]

# display selector
set_property PACKAGE_PIN U2 [get_ports {disp_choice[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_choice[3]}]
set_property PACKAGE_PIN U4 [get_ports {disp_choice[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_choice[2]}]
set_property PACKAGE_PIN V4 [get_ports {disp_choice[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_choice[1]}]
set_property PACKAGE_PIN W4 [get_ports {disp_choice[0]}]					
